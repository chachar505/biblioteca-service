...
public class BibliotecaService {
    ...
    public BibliotecaResponseDTO agregarJuego(BibliotecaRequestDTO dto) {
        ...
        try {
            ...
            usuario = usuarioFeignClient.obtenerUsuarioPorId(
                    dto.getIdUsuario()
            );
        ...
        try {
            juego = juegoFeignClient.obtenerJuegoPorId(
                    dto.getIdJuego()
            );
        ...
        boolean yaExiste =
                bibliotecaRepository.existsByIdUsuarioAndIdJuego(
                        dto.getIdUsuario(),
                        dto.getIdJuego()
                );
    ...
    public List<BibliotecaResponseDTO> obtenerBibliotecaPorUsuario(
            Long idUsuario
    ) {
        ...
        return bibliotecaRepository.findByIdUsuario(idUsuario)
                ...
                .map(entrada -> {
                    ...
                    try {nombreJuego = juegoFeignClient.obtenerJuegoPorId(entrada.getIdJuego()).getNombreJuego();
    ...
    public BibliotecaResponseDTO obtenerPorId(Long id) {
        ...
        BibliotecaUsuario entrada =
                bibliotecaRepository.findById(id)
                        .orElseThrow(() ->
                                new ResourceNotFoundException("Entrada con id " + id + " no encontrada"));
    ...
    public BibliotecaResponseDTO cambiarEstado(
        ...
        BibliotecaUsuario entrada =
                bibliotecaRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Entrada con id " + id + " no encontrada"));
